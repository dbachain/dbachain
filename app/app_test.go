...
func newDbaApp() *DbaApp {
	logger, dbs := loggerAndDBs()
	return NewDbaApp(logger, dbs)
}

func setGenesisAccounts(bapp *DbaApp, accs ...auth.BaseAccount) error {
...
func SignCheckDeliver(t *testing.T, bapp *DbaApp, msg sdk.Msg, seq []int64, expPass bool, priv ...crypto.PrivKeyEd25519) {
...
func CheckBalance(t *testing.T, bapp *DbaApp, addr sdk.Address, balExpected string) {
